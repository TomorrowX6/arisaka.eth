/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 407bf56bc9f67c9319103e871ba134ed)
// Runtime types generated with workerd@1.20260911.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://127.0.0.1:4321,http://localhost:4321" | "https://arisaka.eth.limo";
	DEEPSEEK_API_KEY: string;
	IP_HASH_SECRET: string;
	CHAT_QUOTA: DurableObjectNamespace<import("./src/index").ChatQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatQuota";
	}
	interface LocalEnv {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "DEEPSEEK_API_KEY" | "IP_HASH_SECRET">> {}
}
